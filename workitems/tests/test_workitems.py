...
class TestLibrary:
    ...
    @pytest.fixture
    def inputs(adapter):
        _WorkItemsSingleton._workItems_intance = WorkItems(default_adapter=adapter)
        yield _inputs
...
class TestRobocorpAdapter:
    ...
    def adapter(self, monkeypatch):
        ...
        with mock.patch(
            "robocorp.workitems._workitems._utils.requests.get"
        ) as mock_get, mock.patch(
            "robocorp.workitems._workitems._utils.requests.post"
        ) as mock_post, mock.patch(
            "robocorp.workitems._workitems._utils.requests.put"
        ) as mock_put, mock.patch(
            "robocorp.workitems._workitems._utils.requests.delete"
