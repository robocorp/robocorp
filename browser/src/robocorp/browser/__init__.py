...
def configure(**kwargs) -> None:
    ...
    Args:
        ...
        isolated: Used to define where the browser should be downloaded. If `True`,
        ...
        skip_playwright_stop: Can be used to skip the playwright stop. Not recommended in general,
