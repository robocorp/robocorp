...
def check_browser_install():
    ...
    """
    from robocorp.browser import _browser_engines
    from robocorp.browser._browser_engines import BrowserEngine, install_browser

    original_build_command_line = _browser_engines._build_install_command_line
...
""",
    ...
    _browser_engines._build_install_command_line = mock_func

    try:
        install_browser(BrowserEngine.CHROME, force=True, interactive=False)
    finally:
        _browser_engines._build_install_command_line = original_build_command_line
