...
- Update version (`inv set-version 0.1.1`).
...
- Push contents, and check if tests passed in https://github.com/robocorp/robo/actions.
  - `mu acp robocorp-log release 0.1.1`

- Create a tag (`git tag robocorp-log-0.1.1`) and push it.
...
I'm happy to announce the release of `Robocorp Logging 0.1.1`.
