...
from openapi_client.models.list_step_run_artifacts200_response import ListStepRunArtifacts200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ListStepRunArtifacts200Response:
        ...
        if include_optional:
            return ListStepRunArtifacts200Response(
                data = [
                    openapi_client.models.list_step_run_artifacts_200_response_data_inner.listStepRunArtifacts_200_response_data_inner(
                        id = '', 
                        name = '', 
                        size = 1.337, )
                    ]
