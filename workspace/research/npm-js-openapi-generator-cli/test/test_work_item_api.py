...
from openapi_client.api.work_item_api import WorkItemApi  # noqa: E501
...
class TestWorkItemApi(unittest.TestCase):
    ...
    def test_list_process_run_work_items(self) -> None:
    ...
    def test_list_process_work_items(self) -> None:
