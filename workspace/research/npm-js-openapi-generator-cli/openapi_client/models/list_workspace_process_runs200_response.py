...
class ListWorkspaceProcessRuns200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWorkspaceProcessRuns200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWorkspaceProcessRuns200Response:
        """Create an instance of ListWorkspaceProcessRuns200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWorkspaceProcessRuns200Response.parse_obj(obj)

        _obj = ListWorkspaceProcessRuns200Response.parse_obj({
