...
class WorkItemResource(BaseModel):
    ...
    process_run: Optional[ListProcessRunWorkItems200ResponseDataInnerStepRun] = Field(...)
    step: Optional[ListProcessRunWorkItems200ResponseDataInnerStepRun] = Field(...)
    ...
    __properties = ["id", "created_at", "state", "state_updated_at", "process", "process_run", "step", "step_run", "payload", "files", "exception"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemResource:
        """Create an instance of WorkItemResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemResource.parse_obj(obj)

        _obj = WorkItemResource.parse_obj({
            "id": obj.get("id"),
            ...
            "process_run": ListProcessRunWorkItems200ResponseDataInnerStepRun.from_dict(obj.get("process_run")) if obj.get("process_run") is not None else None,
            "step": ListProcessRunWorkItems200ResponseDataInnerStepRun.from_dict(obj.get("step")) if obj.get("step") is not None else None,
