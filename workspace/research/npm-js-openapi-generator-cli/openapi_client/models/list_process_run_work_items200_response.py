...
class ListProcessRunWorkItems200Response(BaseModel):
    """
    ListProcessRunWorkItems200Response
    """
    next: Next = Field(...)
    has_more: HasMore = Field(...)
    data: conlist(ListProcessRunWorkItems200ResponseDataInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListProcessRunWorkItems200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListProcessRunWorkItems200Response:
        """Create an instance of ListProcessRunWorkItems200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListProcessRunWorkItems200Response.parse_obj(obj)

        _obj = ListProcessRunWorkItems200Response.parse_obj({
            ...
            "data": [ListProcessRunWorkItems200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
