...
class AddWorkerToGroupRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddWorkerToGroupRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddWorkerToGroupRequest:
        """Create an instance of AddWorkerToGroupRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddWorkerToGroupRequest.parse_obj(obj)

        _obj = AddWorkerToGroupRequest.parse_obj({
