...
class UpdateWorkItemPayload200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateWorkItemPayload200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateWorkItemPayload200Response:
        """Create an instance of UpdateWorkItemPayload200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateWorkItemPayload200Response.parse_obj(obj)

        _obj = UpdateWorkItemPayload200Response.parse_obj({
