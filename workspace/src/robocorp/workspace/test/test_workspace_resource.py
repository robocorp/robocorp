...
from workspace.models.workspace_resource import WorkspaceResource  # noqa: E501
    ...
    def make_instance(self, include_optional) -> WorkspaceResource:
        ...
        if include_optional:
            return WorkspaceResource(
                id = '',
                name = '',
                organization = workspace.models.list_assets_200_response_data_inner.listAssets_200_response_data_inner(
                    id = '', 
                    name = '', )
            )
        else:
