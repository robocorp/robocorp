...
from workspace.models.generic_error_response import GenericErrorResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> GenericErrorResponse:
        ...
        if include_optional:
            return GenericErrorResponse(
                error = workspace.models.generic_error_response_error.genericErrorResponse_error(
                    code = '', 
                    message = '', )
            )
        else:
