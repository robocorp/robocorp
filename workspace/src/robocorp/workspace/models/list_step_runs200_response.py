...
class ListStepRuns200Response(BaseModel):
    ...
    data: conlist(StepRunResource) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListStepRuns200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListStepRuns200Response:
        """Create an instance of ListStepRuns200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListStepRuns200Response.parse_obj(obj)

        _obj = ListStepRuns200Response.parse_obj({
