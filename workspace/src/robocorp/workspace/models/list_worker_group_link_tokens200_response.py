...
class ListWorkerGroupLinkTokens200Response(BaseModel):
    ...
    data: conlist(WorkerGroupLinkTokenResource) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWorkerGroupLinkTokens200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWorkerGroupLinkTokens200Response:
        """Create an instance of ListWorkerGroupLinkTokens200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWorkerGroupLinkTokens200Response.parse_obj(obj)

        _obj = ListWorkerGroupLinkTokens200Response.parse_obj({
