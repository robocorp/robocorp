...
class ListStepRunEvents200Response(BaseModel):
    """
    ListStepRunEvents200Response
    """
    next: Next = Field(...)
    has_more: HasMore = Field(...)
    data: conlist(ListStepRunEvents200ResponseDataInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListStepRunEvents200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListStepRunEvents200Response:
        """Create an instance of ListStepRunEvents200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListStepRunEvents200Response.parse_obj(obj)

        _obj = ListStepRunEvents200Response.parse_obj({
            ...
            "data": [ListStepRunEvents200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
