...
class ListWorkerGroups200Response(BaseModel):
    ...
    data: conlist(WorkerGroupResource) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWorkerGroups200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWorkerGroups200Response:
        """Create an instance of ListWorkerGroups200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWorkerGroups200Response.parse_obj(obj)

        _obj = ListWorkerGroups200Response.parse_obj({
            ...
            "data": [WorkerGroupResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
