...
class UpdateWorkItemPayloadRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateWorkItemPayloadRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateWorkItemPayloadRequest:
        """Create an instance of UpdateWorkItemPayloadRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateWorkItemPayloadRequest.parse_obj(obj)

        _obj = UpdateWorkItemPayloadRequest.parse_obj({
