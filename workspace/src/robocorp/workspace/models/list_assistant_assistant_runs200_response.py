...
class ListAssistantAssistantRuns200Response(BaseModel):
    """
    ListAssistantAssistantRuns200Response
    """
    next: Next = Field(...)
    has_more: HasMore = Field(...)
    data: conlist(AssistantRunResource) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListAssistantAssistantRuns200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListAssistantAssistantRuns200Response:
        """Create an instance of ListAssistantAssistantRuns200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListAssistantAssistantRuns200Response.parse_obj(obj)

        _obj = ListAssistantAssistantRuns200Response.parse_obj({
            ...
            "data": [AssistantRunResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
