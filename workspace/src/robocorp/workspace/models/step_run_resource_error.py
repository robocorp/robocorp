...
class StepRunResourceError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StepRunResourceError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StepRunResourceError:
        """Create an instance of StepRunResourceError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StepRunResourceError.parse_obj(obj)

        _obj = StepRunResourceError.parse_obj({
            "code": obj.get("code")
        })
        return _obj
