...
class ListWorkers200Response(BaseModel):
    ...
    data: conlist(WorkerResource) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWorkers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWorkers200Response:
        """Create an instance of ListWorkers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListWorkers200Response.parse_obj(obj)

        _obj = ListWorkers200Response.parse_obj({
            ...
            "data": [WorkerResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
