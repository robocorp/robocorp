...
class PaginationDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginationDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginationDetails:
        """Create an instance of PaginationDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginationDetails.parse_obj(obj)

        _obj = PaginationDetails.parse_obj({
            "next": obj.get("next"),
