...
class CreateTaskPackageRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTaskPackageRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTaskPackageRequest:
        """Create an instance of CreateTaskPackageRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTaskPackageRequest.parse_obj(obj)

        _obj = CreateTaskPackageRequest.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
