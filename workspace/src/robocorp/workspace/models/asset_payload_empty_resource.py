...
class AssetPayloadEmptyResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetPayloadEmptyResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetPayloadEmptyResource:
        """Create an instance of AssetPayloadEmptyResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetPayloadEmptyResource.parse_obj(obj)

        _obj = AssetPayloadEmptyResource.parse_obj({
            "type": obj.get("type")
        })
        return _obj
