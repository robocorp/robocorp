...
class ListProcessRunOutputs200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListProcessRunOutputs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListProcessRunOutputs200Response:
        """Create an instance of ListProcessRunOutputs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListProcessRunOutputs200Response.parse_obj(obj)

        _obj = ListProcessRunOutputs200Response.parse_obj({
            ...
            "data": [ProcessRunOutputResource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
