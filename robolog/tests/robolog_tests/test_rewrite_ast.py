from robolog_tests.test_rewrite_hook import ConfigForTest
...
def test_ast_utils():
    from robocorp.robolog import _ast_utils
    import ast
...
def test_rewrite_ast_just_docstring(tmpdir):
    from robocorp.robolog._config import FilterKind
    from robocorp.robolog._rewrite_importhook import _rewrite
