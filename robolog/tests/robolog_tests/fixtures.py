...
from robocorp.robolog import BaseConfig, FilterKind
from robocorp.robolog.protocols import LogHTMLStyle
...
def ui_regenerate():
    ...
    # from robolog import _robo_output_impl
    #
...
def log_setup(tmpdir):
    ...
    with robolog.setup_auto_logging():
        with robolog.add_log_output(
            ...
            with robolog.add_in_memory_log_output(write=stream.write):
