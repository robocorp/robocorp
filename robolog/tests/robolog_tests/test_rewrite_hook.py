...
from robocorp.robolog._config import ConfigFilesFiltering
from robolog_tests.fixtures import ConfigForTest
from robocorp.robolog.protocols import LogElementType
...
def _setup_test_callbacks():
    from robocorp.robolog import _lifecycle_hooks
...
def test_rewrite_hook_basic(config):
    from robocorp.robolog._rewrite_importhook import RewriteHook
    import sys
...
def test_rewrite_hook_except():
    ...
    import sys
    from imp import reload
    from robolog_tests._resources import check_traceback
...
def test_rewrite_hook_log_on_project_call():
    ...
    import sys
    from imp import reload
    from robolog_tests._resources import check_lib_lib
    from robolog_tests._resources import check_lib_main
