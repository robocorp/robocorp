...
def test_log_with_iterators(tmpdir, ui_regenerate):
    from robolog_tests._resources import check_iterators
        ...
        [
            {
                ...
                "libname": "robolog_tests._resources.check_iterators",
            },
            {
                "message_type": "YS",
                "type": "int",
            ...
            },
            {
                ...
                "libname": "robolog_tests._resources.check_iterators_lib",
